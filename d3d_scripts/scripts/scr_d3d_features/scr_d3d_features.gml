...
d3d_model_vertex_normal_texture_colour(ind,x,y,z,nx,ny,nz,xtec,ytex,col,alpha);
...
d3d_set_depth(depth);
d3d_set_fog(enable,colour,start,einde);
d3d_set_hidden(enable);
d3d_set_lighting(enable);
d3d_set_perspective(enable);
d3d_set_projection(xfrom,yfrom,zfrom,xto,yto,zto,xyp,yup,zup);
d3d_set_projection_ext(xfrom,yfrom,zfrom,xto,yto,zto,xyp,yup,zup,angle,aspect,znear,zfar);
...
d3d_transform_set_scaling(xa,ys,zs);
