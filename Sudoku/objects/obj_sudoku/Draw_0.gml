...
draw_text(room_width*4/5,room_height*0.25/10,"Find S: "+string(solver_find_singles_var));
draw_text(room_width/2,room_height*0.25/10,"Return S: "+string(solver_return_singles_var));